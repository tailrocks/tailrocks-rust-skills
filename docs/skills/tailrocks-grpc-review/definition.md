---
title: "Tailrocks: tailrocks-grpc-review — Skill definition"
description: "Verbatim definition of tailrocks-grpc-review."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-review/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-review/references/runtime-trust.md) to repository, registry,
...
3. **Load only relevant references.** Use
   [`proto-contracts.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-review/references/proto-contracts.md),
   [`tonic-server-client.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-review/references/tonic-server-client.md), and
   [`operations.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-review/references/operations.md). **Complete when:** every
