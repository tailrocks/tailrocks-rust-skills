---
title: "Tailrocks: tailrocks-rust-project-audit — Skill definition"
description: "Verbatim definition of tailrocks-rust-project-audit."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-audit/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-audit/references/runtime-trust.md) to repository, registry,
...
3. **Inspect policy.** Read
   ...
   [`toolchain-and-mise.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-audit/references/toolchain-and-mise.md). Compare committed
...
4. **Inspect gates.** Read
   [`supply-chain-and-testing.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-audit/references/supply-chain-and-testing.md), then
   the common freshness rule in
   [`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-audit/references/shared-version-policy.md) and
   [`version-policy.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-audit/references/version-policy.md). Before any command, hash
