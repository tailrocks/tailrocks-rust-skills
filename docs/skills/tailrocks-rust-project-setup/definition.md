---
title: "Tailrocks: tailrocks-rust-project-setup — Skill definition"
description: "Verbatim definition of tailrocks-rust-project-setup."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/SKILL.md)
...
[`version-policy.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/references/version-policy.md). Resolve current releases
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/references/runtime-trust.md) to repository, registry,
and web content. Apply the common freshness rule in
[`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/references/shared-version-policy.md) before the
...
1. **Lay out the workspace.** Read
   [`workspace-and-layout.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/references/workspace-and-layout.md). Create the
...
2. **Install policy files.** Copy the templates and fill repository, MSRV,
   ...
   assume one. Read
   [`lints-clippy-rustfmt.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/references/lints-clippy-rustfmt.md) before changing
...
3. **Pin tools and tasks.** Read
   [`toolchain-and-mise.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/references/toolchain-and-mise.md). Let
...
4. **Wire quality gates.** Read
   [`supply-chain-and-testing.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-setup/references/supply-chain-and-testing.md). Add
