---
title: "Tailrocks: tailrocks-axum-best-practices — Skill definition"
description: "Verbatim definition of tailrocks-axum-best-practices."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-axum-best-practices/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-axum-best-practices/references/runtime-trust.md) to repository, registry,
...
3. **Load only relevant references.** Choose the minimum set:
   ...
   | Decision | Reference |
   |---|---|
   | Crate seams, routers, typed state, handler thinness | [`architecture-and-state.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-axum-best-practices/references/architecture-and-state.md) |
   | Extractors, validation, errors, response contracts | [`extractors-and-errors.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-axum-best-practices/references/extractors-and-errors.md) |
   | Tower order, limits, auth, CORS, tracing, request IDs | [`middleware-and-security.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-axum-best-practices/references/middleware-and-security.md) |
   | Serving, shutdown, task ownership, blocking work, tests | [`lifecycle-and-testing.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-axum-best-practices/references/lifecycle-and-testing.md) |
