---
title: "Tailrocks: tailrocks-grpc-best-practices — Skill definition"
description: "Verbatim definition of tailrocks-grpc-best-practices."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-best-practices/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-best-practices/references/runtime-trust.md) to repository, registry,
...
3. **Load only relevant references.** Choose the minimum set:
   ...
   | Decision | Reference |
   |---|---|
   | Proto style, field history, presence, pagination, Buf gates | [`proto-contracts.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-best-practices/references/proto-contracts.md) |
   | Codegen, seams, conversions, status, channels, TLS, interceptors | [`tonic-server-client.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-best-practices/references/tonic-server-client.md) |
   | Deadlines, retries, streaming, health, shutdown, observability, wire tests | [`operations.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-grpc-best-practices/references/operations.md) |
