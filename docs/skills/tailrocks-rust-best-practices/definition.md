---
title: "Tailrocks: tailrocks-rust-best-practices — Skill definition"
description: "Verbatim definition of tailrocks-rust-best-practices."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-best-practices/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-best-practices/references/runtime-trust.md) to repository, registry,
...
3. **Load only relevant references.** Choose the minimum set:
   ...
   | Decision | Reference |
   |---|---|
   | Borrowing, cloning, allocation, dispatch, shared state, performance | [`ownership-performance.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-best-practices/references/ownership-performance.md) |
   | Public APIs, traits, naming, constructors, type-state, compatibility | [`api-design.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-best-practices/references/api-design.md) |
   | Errors, panics, tests, doc tests, comments, rustdoc | [`errors-testing-docs.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-best-practices/references/errors-testing-docs.md) |
   | Layout, imports, control flow, naming, module boundaries | [`readability-style-architecture.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-best-practices/references/readability-style-architecture.md) |
   | Clippy findings, suppression, profiling | [`tooling-lints.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-best-practices/references/tooling-lints.md) |
