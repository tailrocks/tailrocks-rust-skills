---
title: "Tailrocks: tailrocks-rust-project-remediate — Skill definition"
description: "Verbatim definition of tailrocks-rust-project-remediate."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-remediate/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-remediate/references/runtime-trust.md) to repository, registry,
...
2. **Resolve the rule.** Read the relevant local references in this order:
   [`workspace-and-layout.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-remediate/references/workspace-and-layout.md),
   [`lints-clippy-rustfmt.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-remediate/references/lints-clippy-rustfmt.md),
   [`toolchain-and-mise.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-remediate/references/toolchain-and-mise.md), then
   [`supply-chain-and-testing.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-project-remediate/references/supply-chain-and-testing.md).
