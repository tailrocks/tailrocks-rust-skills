---
title: "Tailrocks: tailrocks-graphql-review — Skill definition"
description: "Verbatim definition of tailrocks-graphql-review."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-review/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-review/references/runtime-trust.md) to repository, registry,
...
3. **Load only relevant references.** Use
   [`schema-design.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-review/references/schema-design.md),
   [`server-rust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-review/references/server-rust.md),
   [`client-tanstack.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-review/references/client-tanstack.md), and
   [`contract-gates.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-review/references/contract-gates.md) only for inspected
