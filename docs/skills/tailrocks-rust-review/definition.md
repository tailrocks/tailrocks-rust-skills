---
title: "Tailrocks: tailrocks-rust-review — Skill definition"
description: "Verbatim definition of tailrocks-rust-review."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-review/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-review/references/runtime-trust.md) to repository, registry,
...
3. **Load the checklist.** Read
   [`review-checklist.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-rust-review/references/review-checklist.md), then only the relevant
