---
title: "Tailrocks: tailrocks-graphql-best-practices — Skill definition"
description: "Verbatim definition of tailrocks-graphql-best-practices."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-best-practices/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-best-practices/references/runtime-trust.md) to repository, registry,
...
3. **Load only relevant references.** Choose the minimum set:
   ...
   | Decision | Reference |
   |---|---|
   | Naming, pagination, IDs, mutations, nullability, polymorphism | [`schema-design.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-best-practices/references/schema-design.md) |
   | Juniper layout, loaders, errors, limits, persisted operations | [`server-rust.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-best-practices/references/server-rust.md) |
   | Codegen, TanStack Query, fragments, client errors | [`client-tanstack.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-best-practices/references/client-tanstack.md) |
   | SDL snapshot, breaking diff, deprecation, evolution | [`contract-gates.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-graphql-best-practices/references/contract-gates.md) |
