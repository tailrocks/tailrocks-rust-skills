---
title: "Tailrocks: tailrocks-tui-design — Skill definition"
description: "Verbatim definition of tailrocks-tui-design."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-tui-design/SKILL.md)
...
1. **Collect screens.** From the roadmap item, the conversation, or both:
   ...
   renders. Read [`tui-craft.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-tui-design/references/tui-craft.md) before any
...
2. **Build or extend the gallery.** Read
   [`gallery.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-tui-design/references/gallery.md); copy the crate skeleton from
   [`templates/gallery/`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-tui-design/templates/gallery/) rather than deriving it. The
...
4. **Freeze the goldens.** Read
   [`golden-frames.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-tui-design/references/golden-frames.md). Write frames with the
...
5. **Wire the handoff.** Read
   [`screen-package.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-tui-design/references/screen-package.md) for where artifacts
...
Depth lives in [`tui-craft.md`](https://github.com/tailrocks/tailrocks-rust-skills/blob/main/skills/tailrocks-tui-design/references/tui-craft.md). One rule carries
